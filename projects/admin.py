...
from .models import (
    Project, Category, Tag, ProjectImage,
    Rating, Comment, Donation
)
...
class ProjectAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        required_fields = ['title', 'details', 'category', 'user','start_time','total'] 
...
class ProjectAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'user', 'category', 'total', 'progress_percentage', 'is_featured', 'is_cancelled')
    ...
    readonly_fields = ('progress_percentage', 'current_donation', 'average_rating', 'rating_count', 'days_remaining', 'can_cancel')
